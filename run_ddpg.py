...
def parse_args():
    ...
    parser.add_argument('--critic-l2-reg', type=float, default=0.00005)
    ...
    parser.add_argument('--noise-type', type=str, default='adaptive-param_0.005')  # choices are adaptive-param_xx, ou_xx, normal_xx, none
    parser.add_argument('--teacher', type=float, default=0.2)  # Probability that the teacher guides us
