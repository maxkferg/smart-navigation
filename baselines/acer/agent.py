...
class Agent():
    ...
    def build_graph(self):
        ...
        INPUT_SHAPE = tuple([None]+list(self.INPUT_DIM))

        self.x_i = tf.placeholder(dtype=tf.float32, shape = INPUT_SHAPE, name="x_i")
    ...
    def train_off_policy(self, sess):
        ...
        opt_feed_dict = {
            self.x_i : np.asarray(states).reshape(-1, self.INPUT_DIM[0], self.INPUT_DIM[1]),
