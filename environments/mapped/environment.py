...
class LearningEnvironment:
    ...
    def __init__(self, num_particles=4, particle_size=30, disable_render=False):
        ...
        self.observation_space = ObservationSpace(num_particles * self.state_dimensions + self.discretization**2)
    ...
    def _step(self, action):
        ...
        elif collisions > 0 or self.universe.isOnPenalty(self.primary):
